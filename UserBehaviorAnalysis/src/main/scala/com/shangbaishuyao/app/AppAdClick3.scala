...
import com.shangbaishuyao.Handler.{ResultAppClick, filterProcessFunctionStatePutRedis, myAggregateAppClick}
 ...
 *  <p> 但是我的数据都存在redis里面是有风险的. 我想直接在redis里面做这个事情也是可以的.</p>
 *
 *
...
object AppAdClick3 {
  def main(args: Array[String]): Unit = {
    ...
    val sideSteam: DataStream[adClick] = keyedStream.process(new filterProcessFunctionStatePutRedis(6, outPutTag))
    //打印侧输出流
